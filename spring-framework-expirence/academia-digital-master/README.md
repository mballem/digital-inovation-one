...
Projeto atualizo com a inclusão de documentação
Swagger 2. Acesso da documentação via url: 
http://localhost:8080/swagger-ui.html

Inclusão de métodos adicionais ou não implementados pela autora do projeto.
