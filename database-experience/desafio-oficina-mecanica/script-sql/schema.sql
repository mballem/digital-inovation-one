...
CHANGE COLUMN DATA_ENTREGA DATA_ENTREGA DATE NULL ;
...
ALTER TABLE ORDENS_SERVICO_TEM_TIPOS_DE_SERVICOS
DROP FOREIGN KEY fk_TIPOS_DE_SERVICOS_has_ORDENS_DE_SERVICO_ORDENS_DE_SERVICO1,
DROP FOREIGN KEY fk_TIPOS_DE_SERVICOS_has_ORDENS_DE_SERVICO_TIPOS_DE_SERVICOS1;
ALTER TABLE ORDENS_SERVICO_TEM_TIPOS_DE_SERVICOS
CHANGE COLUMN TIPOS_DE_SERVICOS_ID_TIPO_SERVICO ID_TIPO_SERVICO INT NOT NULL ,
CHANGE COLUMN ORDENS_DE_SERVICO_ID_ORDENS_DE_SERVICO ID_ORDENS_DE_SERVICO INT NOT NULL ;
ALTER TABLE ORDENS_SERVICO_TEM_TIPOS_DE_SERVICOS
ADD CONSTRAINT fk_TIPOS_DE_SERVICOS_has_ORDENS_DE_SERVICO_ORDENS_DE_SERVICO1
  FOREIGN KEY (ID_ORDENS_DE_SERVICO)
  REFERENCES ORDENS_DE_SERVICO (ID_ORDENS_DE_SERVICO),
ADD CONSTRAINT fk_TIPOS_DE_SERVICOS_has_ORDENS_DE_SERVICO_TIPOS_DE_SERVICOS1
...
ALTER TABLE mecanicos_tem_especialidades 
DROP FOREIGN KEY fk_MECANICOS_has_ESPECIALIDADES_ESPECIALIDADES1;

ALTER TABLE mecanicos_tem_especialidades 
CHANGE COLUMN ESPECIAID_ESPECIALIDADE ID_ESPECIALIDADE INT NOT NULL ;

ALTER TABLE mecanicos_tem_especialidades 
ADD CONSTRAINT fk_MECANICOS_has_ESPECIALIDADES_ESPECIALIDADES1
